...
#define VEICOLO_H //lo definiamo se non definito
...
class Veicolo {
	...
	public:
		...
		virtual std::string toString() const = 0; //Plur virtual perchè questo metodo serve alle altre classi e non da istanziare a veicolo.
		...
		//FINTO COSTRUTTORE PER LA CLASSE VIRTUALE VEICOLO RIDEFINENDO L'OPERATORE =
